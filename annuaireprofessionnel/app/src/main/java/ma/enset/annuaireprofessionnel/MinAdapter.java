...
public class MinAdapter extends RecyclerView.Adapter<MinAdapter.ViewHolder>  {
    ...
    public void onBindViewHolder(@NonNull MinAdapter.ViewHolder holder, int position) {
        ...
        holder.text_nome.setText(contact.getFirst_name());
        holder.text_prenom.setText(contact.getLast_name());
        holder.text_phone.setText(contact.getPhone());
        holder.text_email.setText(contact.getEmail());
        ...
        holder.btt_img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
